...
namespace Conduit
{
    ...
    static class BridgeObjectId
    {
        ...
        internal const string Prefix = "eid:";
#else
        internal const string Prefix = "id:";
#endif

        internal static ulong Get(Object target)
        {
        ...
        internal static Object? Resolve(ulong objectId)
        {
#if UNITY_6000_4_OR_NEWER
        ...
        internal static string Format(Object target) => Format(Get(target));

        internal static string Format(ulong objectId)
        {
#if UNITY_6000_4_OR_NEWER
        ...
        internal static bool TryParse(string value, out ulong objectId)
            => TryParse(value.AsSpan(), out objectId);

        internal static bool TryParse(ReadOnlySpan<char> value, out ulong objectId)
        {
#if UNITY_6000_4_OR_NEWER
