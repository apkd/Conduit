...
namespace Conduit
{
    ...
    {
        internal const int Version = BridgeContract.Version;

        internal static string Serialize(BridgeMessage message)
        ...
        internal static BridgeMessage? Deserialize(string payload)
        {
